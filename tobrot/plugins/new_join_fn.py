    ...
    if chat_type != "private":
        await message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton('Github', url='https://github.com/arunsingh-creator')
                    ]
                ]
               )
            )
